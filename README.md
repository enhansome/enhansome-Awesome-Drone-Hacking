...
* [Damn Vulnerable Drone (DVD)](https://github.com/nicholasaleks/Damn-Vulnerable-Drone) ⭐ 826 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-08 - Docker-based virtual drone hacking simulator.
...
* [American Fuzzy Lop plus plus](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,768 | 🐛 22 | 🌐 C | 📅 2026-09-21 - AFL with community patches, qemu 5.1 upgrade, collision-free coverage, enhanced laf-intel & redqueen, AFLfast++ power schedules, MOpt mutators, unicorn\_mode, and a lot more!
* [Avatar² Framework](https://github.com/avatartwo/avatar2) ⭐ 577 | 🐛 27 | 🌐 Python | 📅 2025-03-31 - Fuzzware is a project for automated, self-configuring fuzzing of firmware images.
...
* [Renode](https://github.com/renode/renode) ⭐ 2,928 | 🐛 457 | 🌐 RobotFramework | 📅 2026-09-24 - Antmicro's open source simulation and virtual development framework for complex embedded systems. Supports many [STM32](https://github.com/renode/renode/blob/master/platforms/cpus/stm32f4.repl) ⭐ 2,928 | 🐛 457 | 🌐 RobotFramework | 📅 2026-09-24 series chips.
...
* [Glasgow](https://github.com/GlasgowEmbedded/Glasgow) ⭐ 2,211 | 🐛 78 | 🌐 Python | 📅 2026-09-24 - Tool for exploring and debugging different digital interfaces.
...
* [RemoteID Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 568 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU tool that simulates up to 16 fake Remote ID–broadcasting drones around a GPS location via Wi‑Fi for Red Team testing.
...
* [HackRF One](https://github.com/greatscottgadgets/hackrf) ⭐ 8,127 | 🐛 86 | 🌐 C | 📅 2026-09-24 - Software Defined Radio peripheral capable of transmission or reception of radio signals from 1 MHz to 6 GHz (half-duplex).
* [GNURadio](https://github.com/gnuradio/gnuradio) ⭐ 6,268 | 🐛 607 | 🌐 C++ | 📅 2026-08-27 - Free and Open Software Radio Ecosystem.
* [SDRangel](https://github.com/f4exb/sdrangel) ⭐ 4,068 | 🐛 96 | 🌐 C++ | 📅 2026-09-24 - Open-source Qt5 / OpenGL 3.0+ SDR and signal analyzer frontend to various hardware.
* [GQRX](https://github.com/gqrx-sdr/gqrx) ⭐ 3,686 | 🐛 270 | 🌐 C++ | 📅 2026-08-06 - Software defined radio receiver powered by GNU Radio and Qt.
* [SigDigger](https://github.com/BatchDrake/SigDigger) ⭐ 2,899 | 🐛 74 | 🌐 C++ | 📅 2026-02-11 - Free digital signal analyzer.
* [UberTooth One](https://github.com/greatscottgadgets/ubertooth) ⭐ 2,136 | 🐛 53 | 🌐 C | 📅 2026-03-19 - Open source 2.4 GHz wireless development platform suitable for Bluetooth experimentation.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 20,022 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - MITM framework to hijack drone app traffic.
* [WifiPhisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,851 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Automated Evil Twin to phish Drone app creds.
...
* [WFB-ng](https://github.com/svpcom/wfb-ng) ⭐ 1,540 | 🐛 23 | 🌐 Python | 📅 2026-09-23 - Low‑latency UDP Wi‑Fi broadcast for FPV drones.
...
* [LTE Sniffer](https://github.com/SysSec-KAIST/LTESniffer) ⭐ 2,233 | 🐛 26 | 🌐 C++ | 📅 2024-10-23 - Open-source LTE downlink/uplink eavesdropper.
* [QCSuper](https://github.com/P1sec/QCSuper) ⭐ 1,653 | 🐛 121 | 🌐 Python | 📅 2026-07-23 - Capture 2G-4G traffic using Qualcomm phones.
* [gr-gsm](https://github.com/ptrkrysik/gr-gsm) ⭐ 1,499 | 🐛 164 | 🌐 C++ | 📅 2025-03-10 - GSM analysis with GNU Radio.
...
* [MAVLink](https://github.com/mavlink/mavlink) ⭐ 2,436 | 🐛 114 | 🌐 Python | 📅 2026-09-24 - Marshalling / communication library for drones.
* [MAVROS](https://github.com/mavlink/mavros) ⭐ 1,225 | 🐛 405 | 🌐 C++ | 📅 2026-09-18 - MAVLink to ROS gateway with proxy for Ground Control Station.
...
* [Betaflight](https://github.com/betaflight/betaflight) ⭐ 11,574 | 🐛 355 | 🌐 C | 📅 2026-09-23 - Open Source Flight Controller Firmware for FPV Drones.
* [iNav](https://github.com/iNavFlight/inav) ⭐ 4,229 | 🐛 448 | 🌐 C | 📅 2026-09-24 - Navigation-enabled flight control software.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,536 | 🐛 1,964 | 🌐 Java | 📅 2026-09-21 - Software Reverse Engineering suite; handles arbitrary binaries, if you provide CPU architecture and endianness of the binary.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,864 | 🐛 822 | 🌐 C | 📅 2026-09-24 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,368 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,675 | 🐛 14 | 🌐 Shell | 📅 2026-09-23 - Analyze Linux-based firmware of embedded devices.
* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,360 | 🐛 30 | 🌐 Rust | 📅 2026-08-20 - Finds vulnerable patterns in binary executables - ELF support for x86, ARM, and MIPS, experimental bare-metal support.
...
* [DJI Firmware Tools](https://github.com/o-gs/dji-firmware-tools) ⭐ 2,223 | 🐛 280 | 🌐 C | 📅 2026-07-21 - Utilities to extract, modify, and rebuild DJI drone firmware modules—including calibration, parameter editing, and repackaging for analysis.
* [flashrom](https://github.com/flashrom/flashrom) ⭐ 1,173 | 🐛 80 | 🌐 C | 📅 2026-09-21 - Tool for detecting, reading, writing, verifying and erasing flash chips.
...
* [FACT Extractor](https://github.com/fkie-cad/fact_extractor) ⭐ 91 | 🐛 44 | 🌐 Python | 📅 2026-09-02 - Detects container format automatically and executes the corresponding extraction tool.
...
* [QGround Control](https://github.com/mavlink/qgroundcontrol) ⭐ 4,977 | 🐛 1,058 | 🌐 C++ | 📅 2026-09-24 - Cross-platform ground control station for drones.
* [MAVProxy](https://github.com/ArduPilot/MAVProxy) ⭐ 596 | 🐛 272 | 🌐 Python | 📅 2026-09-24 - CLI-based GCS Software.
* [Mission Planner](https://ardupilot.org/planner/) - Windows-based GCS Software.

## 📱 Mobile GCS Apps

* [Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,652 | 🐛 77 | 🌐 Java | 📅 2026-09-21 - A tool for reverse engineering Android apk files.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,825 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - Automated, all in one mobile application hacking.
* [Dex2Jar](https://github.com/pxb1988/dex2jar) ⭐ 13,145 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Tools to work with android .dex and java .class files.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,287 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Reverse engineering and pentesting for Android applications.
* [ADB Toolkit](https://github.com/ASHWIN990/ADB-Toolkit) ⭐ 2,031 | 🐛 25 | 🌐 Shell | 📅 2024-08-18 - ADB-Toolkit V2 for easy ADB tricks with many perks in all one.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,950 | 🐛 2,767 | 🌐 C++ | 📅 2026-09-24 - Open Source Computer Vision Library.

## 🏢 Vendor-Specific Research

### DJI

* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,320 | 🐛 21 | 🌐 Python | 📅 2023-03-10
* [DJI Drone ID](https://github.com/proto17/dji_droneid) ⭐ 544 | 🐛 34 | 🌐 MATLAB | 📅 2024-05-27 - An SDR-based decoder that demodulates proprietary DJI DroneID RF bursts and allows creation of arbitrary DroneID frames using MATLAB/Octave scripts.
...
* [DroneSploit](https://github.com/dronesploit/dronesploit) ⭐ 2,185 | 🐛 2 | 🌐 Python | 📅 2024-11-23 - Drone pentesting framework console.
...
* [Robot Vulnerability Database](https://github.com/aliasrobotics/RVD) ⭐ 243 | 🐛 227 | 🌐 Python | 📅 2026-07-14 - An open archive tracking robot/ROS vulnerabilities with RVSS scoring, curated by Alias Robotics.
* [Infected Drones](https://github.com/nicholasaleks/infected-drones) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - A collection of vulnerabilities & exploits against modern GCS
...
* [PX4](https://github.com/PX4/PX4-Autopilot/blob/main/SECURITY.md) ⭐ 12,685 | 🐛 392 | 🌐 C++ | 📅 2026-09-24 - PX4 Security Policy.
* [QGround Control](https://github.com/mavlink/qgroundcontrol/security) ⭐ 4,977 | 🐛 1,058 | 🌐 C++ | 📅 2026-09-24 - QGround Control Vulnerability Disclosure.
* [ArduPilot](https://github.com/ArduPilot/MethodicConfigurator/security) ⭐ 160 | 🐛 38 | 🌐 Python | 📅 2026-09-24 - ArduPilot Vulnerability Disclosure.
