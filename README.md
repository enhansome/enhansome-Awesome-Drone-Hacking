...
* [Damn Vulnerable Drone (DVD)](https://github.com/nicholasaleks/Damn-Vulnerable-Drone) ⭐ 810 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-08 - Docker-based virtual drone hacking simulator.
...
* [American Fuzzy Lop plus plus](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,750 | 🐛 23 | 🌐 C | 📅 2026-09-04 - AFL with community patches, qemu 5.1 upgrade, collision-free coverage, enhanced laf-intel & redqueen, AFLfast++ power schedules, MOpt mutators, unicorn\_mode, and a lot more!
...
* [Fuzzware](https://github.com/fuzzware-fuzzer/fuzzware) ⭐ 384 | 🐛 15 | 🌐 Python | 📅 2026-06-27 - The target orchestration framework with focus on dynamic analysis of embedded devices' firmware.

## Emulators

* [Renode](https://github.com/renode/renode) ⭐ 2,867 | 🐛 440 | 🌐 RobotFramework | 📅 2026-09-10 - Antmicro's open source simulation and virtual development framework for complex embedded systems. Supports many [STM32](https://github.com/renode/renode/blob/master/platforms/cpus/stm32f4.repl) ⭐ 2,867 | 🐛 440 | 🌐 RobotFramework | 📅 2026-09-10 series chips.
...
* [Glasgow](https://github.com/GlasgowEmbedded/Glasgow) ⭐ 2,206 | 🐛 79 | 🌐 Python | 📅 2026-09-09 - Tool for exploring and debugging different digital interfaces.
...
* [RemoteID Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 566 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU tool that simulates up to 16 fake Remote ID–broadcasting drones around a GPS location via Wi‑Fi for Red Team testing.
* [DragonSync-iOS](https://github.com/Root-Down-Digital/DragonSync-iOS) ⭐ 272 | 🐛 0 | 🌐 Swift | 📅 2026-08-27 - Real-time Remote/Drone ID–compliant drone detection and monitoring on iOS/macOS.
...
* [HackRF One](https://github.com/greatscottgadgets/hackrf) ⭐ 8,090 | 🐛 83 | 🌐 C | 📅 2026-09-08 - Software Defined Radio peripheral capable of transmission or reception of radio signals from 1 MHz to 6 GHz (half-duplex).
* [GNURadio](https://github.com/gnuradio/gnuradio) ⭐ 6,253 | 🐛 598 | 🌐 C++ | 📅 2026-08-27 - Free and Open Software Radio Ecosystem.
* [SDRangel](https://github.com/f4exb/sdrangel) ⭐ 3,972 | 🐛 85 | 🌐 C++ | 📅 2026-09-09 - Open-source Qt5 / OpenGL 3.0+ SDR and signal analyzer frontend to various hardware.
* [GQRX](https://github.com/gqrx-sdr/gqrx) ⭐ 3,674 | 🐛 267 | 🌐 C++ | 📅 2026-08-06 - Software defined radio receiver powered by GNU Radio and Qt.
* [SigDigger](https://github.com/BatchDrake/SigDigger) ⭐ 2,887 | 🐛 74 | 🌐 C++ | 📅 2026-02-11 - Free digital signal analyzer.
* [UberTooth One](https://github.com/greatscottgadgets/ubertooth) ⭐ 2,131 | 🐛 52 | 🌐 C | 📅 2026-03-19 - Open source 2.4 GHz wireless development platform suitable for Bluetooth experimentation.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,954 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - MITM framework to hijack drone app traffic.
* [WifiPhisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,830 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Automated Evil Twin to phish Drone app creds.
...
* [WFB-ng](https://github.com/svpcom/wfb-ng) ⭐ 1,529 | 🐛 23 | 🌐 Python | 📅 2026-08-27 - Low‑latency UDP Wi‑Fi broadcast for FPV drones.
...
* [RX5808 Pro Diversity](https://github.com/sheaivey/rx5808-pro-diversity) ⭐ 750 | 🐛 42 | 🌐 C++ | 📅 2024-02-21 - DIY 5.8 GHz FPV video receiver station with antenna diversity.
...
* [LTE Sniffer](https://github.com/SysSec-KAIST/LTESniffer) ⭐ 2,225 | 🐛 26 | 🌐 C++ | 📅 2024-10-23 - Open-source LTE downlink/uplink eavesdropper.
* [QCSuper](https://github.com/P1sec/QCSuper) ⭐ 1,646 | 🐛 121 | 🌐 Python | 📅 2026-07-23 - Capture 2G-4G traffic using Qualcomm phones.
* [gr-gsm](https://github.com/ptrkrysik/gr-gsm) ⭐ 1,497 | 🐛 163 | 🌐 C++ | 📅 2025-03-10 - GSM analysis with GNU Radio.
* [LTE-Cell-Scanner](https://github.com/Evrytania/LTE-Cell-Scanner) ⭐ 671 | 🐛 33 | 🌐 C++ | 📅 2019-02-26 - LTE cell detection and analysis.
* [FALCON LTE](https://github.com/falkenber9/falcon) ⭐ 362 | 🐛 16 | 🌐 C++ | 📅 2023-10-13 - Fast Analysis of LTE Control Channels for real-time analysis.
...
* [MAVLink](https://github.com/mavlink/mavlink) ⭐ 2,423 | 🐛 120 | 🌐 Python | 📅 2026-09-09 - Marshalling / communication library for drones.
* [MAVROS](https://github.com/mavlink/mavros) ⭐ 1,221 | 🐛 400 | 🌐 C++ | 📅 2026-09-09 - MAVLink to ROS gateway with proxy for Ground Control Station.
* [MAVSDK](https://github.com/mavlink/MAVSDK) ⭐ 932 | 🐛 52 | 🌐 C++ | 📅 2026-09-08 - API and library for MAVLink compatible systems written in C++17.
...
* [Betaflight](https://github.com/betaflight/betaflight) ⭐ 11,518 | 🐛 357 | 🌐 C | 📅 2026-09-09 - Open Source Flight Controller Firmware for FPV Drones.
* [iNav](https://github.com/iNavFlight/inav) ⭐ 4,214 | 🐛 438 | 🌐 C | 📅 2026-09-09 - Navigation-enabled flight control software.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,722 | 🐛 1,946 | 🌐 Java | 📅 2026-09-08 - Software Reverse Engineering suite; handles arbitrary binaries, if you provide CPU architecture and endianness of the binary.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,772 | 🐛 818 | 🌐 C | 📅 2026-09-10 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,327 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,653 | 🐛 13 | 🌐 Shell | 📅 2026-09-09 - Analyze Linux-based firmware of embedded devices.
* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,355 | 🐛 29 | 🌐 Rust | 📅 2026-08-20 - Finds vulnerable patterns in binary executables - ELF support for x86, ARM, and MIPS, experimental bare-metal support.
...
* [DJI Firmware Tools](https://github.com/o-gs/dji-firmware-tools) ⭐ 2,207 | 🐛 278 | 🌐 C | 📅 2026-07-21 - Utilities to extract, modify, and rebuild DJI drone firmware modules—including calibration, parameter editing, and repackaging for analysis.
* [flashrom](https://github.com/flashrom/flashrom) ⭐ 1,169 | 🐛 80 | 🌐 C | 📅 2026-09-07 - Tool for detecting, reading, writing, verifying and erasing flash chips.
...
* [QGround Control](https://github.com/mavlink/qgroundcontrol) ⭐ 4,914 | 🐛 1,032 | 🌐 C++ | 📅 2026-09-10 - Cross-platform ground control station for drones.
* [MAVProxy](https://github.com/ArduPilot/MAVProxy) ⭐ 595 | 🐛 271 | 🌐 Python | 📅 2026-09-09 - CLI-based GCS Software.
* [Mission Planner](https://ardupilot.org/planner/) - Windows-based GCS Software.

## 📱 Mobile GCS Apps

* [Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,517 | 🐛 77 | 🌐 Java | 📅 2026-09-04 - A tool for reverse engineering Android apk files.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,734 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 - Automated, all in one mobile application hacking.
* [Dex2Jar](https://github.com/pxb1988/dex2jar) ⭐ 13,139 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Tools to work with android .dex and java .class files.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,235 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Reverse engineering and pentesting for Android applications.
* [ADB Toolkit](https://github.com/ASHWIN990/ADB-Toolkit) ⭐ 2,026 | 🐛 25 | 🌐 Shell | 📅 2024-08-18 - ADB-Toolkit V2 for easy ADB tricks with many perks in all one.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,783 | 🐛 2,781 | 🌐 C++ | 📅 2026-09-10 - Open Source Computer Vision Library.

## 🏢 Vendor-Specific Research

### DJI

* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,315 | 🐛 21 | 🌐 Python | 📅 2023-03-10
...
* [dji\_rev](https://github.com/fvantienen/dji_rev) ⭐ 321 | 🐛 7 | 🌐 C++ | 📅 2017-09-13 - DJI Reverse Engineering Toolkit.
...
* [DroneSploit](https://github.com/dronesploit/dronesploit) ⭐ 2,177 | 🐛 2 | 🌐 Python | 📅 2024-11-23 - Drone pentesting framework console.
...
* [PX4](https://github.com/PX4/PX4-Autopilot/blob/main/SECURITY.md) ⭐ 12,585 | 🐛 364 | 🌐 C++ | 📅 2026-09-10 - PX4 Security Policy.
* [QGround Control](https://github.com/mavlink/qgroundcontrol/security) ⭐ 4,914 | 🐛 1,032 | 🌐 C++ | 📅 2026-09-10 - QGround Control Vulnerability Disclosure.
* [ArduPilot](https://github.com/ArduPilot/MethodicConfigurator/security) ⭐ 157 | 🐛 31 | 🌐 Python | 📅 2026-09-09 - ArduPilot Vulnerability Disclosure.
...
* [Awesome-Flying-FPV](https://github.com/Matthias84/awesome-flying-fpv) ⭐ 697 | 🐛 5 | 📅 2026-03-06 - Awesome Flying FPV List.
