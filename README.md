...
* [Damn Vulnerable Drone (DVD)](https://github.com/nicholasaleks/Damn-Vulnerable-Drone) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-08 - Docker-based virtual drone hacking simulator.
...
* [American Fuzzy Lop plus plus](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,740 | 🐛 22 | 🌐 C | 📅 2026-08-29 - AFL with community patches, qemu 5.1 upgrade, collision-free coverage, enhanced laf-intel & redqueen, AFLfast++ power schedules, MOpt mutators, unicorn\_mode, and a lot more!
...
* [Renode](https://github.com/renode/renode) ⭐ 2,796 | 🐛 429 | 🌐 RobotFramework | 📅 2026-08-28 - Antmicro's open source simulation and virtual development framework for complex embedded systems. Supports many [STM32](https://github.com/renode/renode/blob/master/platforms/cpus/stm32f4.repl) ⭐ 2,796 | 🐛 429 | 🌐 RobotFramework | 📅 2026-08-28 series chips.
...
* [Glasgow](https://github.com/GlasgowEmbedded/Glasgow) ⭐ 2,202 | 🐛 80 | 🌐 Python | 📅 2026-08-29 - Tool for exploring and debugging different digital interfaces.
...
* [HackRF One](https://github.com/greatscottgadgets/hackrf) ⭐ 8,063 | 🐛 83 | 🌐 C | 📅 2026-08-28 - Software Defined Radio peripheral capable of transmission or reception of radio signals from 1 MHz to 6 GHz (half-duplex).
* [GNURadio](https://github.com/gnuradio/gnuradio) ⭐ 6,242 | 🐛 597 | 🌐 C++ | 📅 2026-08-27 - Free and Open Software Radio Ecosystem.
* [SDRangel](https://github.com/f4exb/sdrangel) ⭐ 3,946 | 🐛 89 | 🌐 C++ | 📅 2026-08-23 - Open-source Qt5 / OpenGL 3.0+ SDR and signal analyzer frontend to various hardware.
* [GQRX](https://github.com/gqrx-sdr/gqrx) ⭐ 3,669 | 🐛 265 | 🌐 C++ | 📅 2026-08-06 - Software defined radio receiver powered by GNU Radio and Qt.
* [SigDigger](https://github.com/BatchDrake/SigDigger) ⭐ 2,879 | 🐛 74 | 🌐 C++ | 📅 2026-02-11 - Free digital signal analyzer.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,908 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - MITM framework to hijack drone app traffic.
* [WifiPhisher](https://github.com/wifiphisher/wifiphisher) ⭐ 14,797 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Automated Evil Twin to phish Drone app creds.
...
* [WFB-ng](https://github.com/svpcom/wfb-ng) ⭐ 1,519 | 🐛 23 | 🌐 Python | 📅 2026-08-27 - Low‑latency UDP Wi‑Fi broadcast for FPV drones.
...
* [QCSuper](https://github.com/P1sec/QCSuper) ⭐ 1,642 | 🐛 121 | 🌐 Python | 📅 2026-07-23 - Capture 2G-4G traffic using Qualcomm phones.
...
* [MAVLink](https://github.com/mavlink/mavlink) ⭐ 2,407 | 🐛 119 | 🌐 Python | 📅 2026-08-29 - Marshalling / communication library for drones.
...
* [MAVSDK](https://github.com/mavlink/MAVSDK) ⭐ 929 | 🐛 50 | 🌐 C++ | 📅 2026-08-30 - API and library for MAVLink compatible systems written in C++17.
...
* [Betaflight](https://github.com/betaflight/betaflight) ⭐ 11,478 | 🐛 370 | 🌐 C | 📅 2026-08-30 - Open Source Flight Controller Firmware for FPV Drones.
* [iNav](https://github.com/iNavFlight/inav) ⭐ 4,205 | 🐛 425 | 🌐 C | 📅 2026-08-30 - Navigation-enabled flight control software.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 73,646 | 🐛 1,922 | 🌐 Java | 📅 2026-08-28 - Software Reverse Engineering suite; handles arbitrary binaries, if you provide CPU architecture and endianness of the binary.
* [Radare2](https://github.com/radareorg/radare2) ⭐ 24,677 | 🐛 820 | 🌐 C | 📅 2026-08-30 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,291 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,618 | 🐛 25 | 🌐 Shell | 📅 2026-08-27 - Analyze Linux-based firmware of embedded devices.
...
* [DJI Firmware Tools](https://github.com/o-gs/dji-firmware-tools) ⭐ 2,190 | 🐛 276 | 🌐 C | 📅 2026-07-21 - Utilities to extract, modify, and rebuild DJI drone firmware modules—including calibration, parameter editing, and repackaging for analysis.
* [flashrom](https://github.com/flashrom/flashrom) ⭐ 1,170 | 🐛 80 | 🌐 C | 📅 2026-08-28 - Tool for detecting, reading, writing, verifying and erasing flash chips.
...
* [QGround Control](https://github.com/mavlink/qgroundcontrol) ⭐ 4,881 | 🐛 1,002 | 🌐 C++ | 📅 2026-08-30 - Cross-platform ground control station for drones.
* [MAVProxy](https://github.com/ArduPilot/MAVProxy) ⭐ 592 | 🐛 271 | 🌐 Python | 📅 2026-08-30 - CLI-based GCS Software.
* [Mission Planner](https://ardupilot.org/planner/) - Windows-based GCS Software.

## 📱 Mobile GCS Apps

* [Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,415 | 🐛 83 | 🌐 Java | 📅 2026-08-29 - A tool for reverse engineering Android apk files.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,664 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-27 - Automated, all in one mobile application hacking.
* [Dex2Jar](https://github.com/pxb1988/dex2jar) ⭐ 13,137 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Tools to work with android .dex and java .class files.
* [Androguard](https://github.com/androguard/androguard) ⭐ 6,215 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineering and pentesting for Android applications.
* [ADB Toolkit](https://github.com/ASHWIN990/ADB-Toolkit) ⭐ 2,018 | 🐛 25 | 🌐 Shell | 📅 2024-08-18 - ADB-Toolkit V2 for easy ADB tricks with many perks in all one.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,642 | 🐛 2,758 | 🌐 C++ | 📅 2026-08-29 - Open Source Computer Vision Library.

## 🏢 Vendor-Specific Research

### DJI

* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,312 | 🐛 21 | 🌐 Python | 📅 2023-03-10
* [DJI Drone ID](https://github.com/proto17/dji_droneid) ⭐ 539 | 🐛 35 | 🌐 MATLAB | 📅 2024-05-27 - An SDR-based decoder that demodulates proprietary DJI DroneID RF bursts and allows creation of arbitrary DroneID frames using MATLAB/Octave scripts.
* [deejaeye-Modder](https://github.com/Bin4ry/deejayeye-modder) ⭐ 399 | 🐛 42 | 🌐 Smali | 📅 2021-12-09 - DJI Drone Firmware Modding Tool.
* [DroneXtract](https://github.com/ANG13T/DroneXtract) ⭐ 365 | 🐛 6 | 🌐 Go | 📅 2023-07-19 - Digital forensics suite for DJI drones.
...
* [PX4](https://github.com/PX4/PX4-Autopilot/blob/main/SECURITY.md) ⭐ 12,515 | 🐛 327 | 🌐 C++ | 📅 2026-08-30 - PX4 Security Policy.
* [QGround Control](https://github.com/mavlink/qgroundcontrol/security) ⭐ 4,881 | 🐛 1,002 | 🌐 C++ | 📅 2026-08-30 - QGround Control Vulnerability Disclosure.
* [ArduPilot](https://github.com/ArduPilot/MethodicConfigurator/security) ⭐ 155 | 🐛 26 | 🌐 Python | 📅 2026-08-29 - ArduPilot Vulnerability Disclosure.
